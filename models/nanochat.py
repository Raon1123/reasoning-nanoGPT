"""
GPT model (rewrite, a lot simpler) from NanoChat:
Notable features:
...
from src.toolkits import get_dist_info
from models.muon import Muon, DistMuon
from models.adamw import DistAdamW
